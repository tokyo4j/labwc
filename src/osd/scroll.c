...
get_cycle_idx(struct output *output)
{
	...
	/*
	 * TODO: This can happen when new windows are created during window
	 * switching. We should refresh the osd in that case so that we can
	 * always find the osd item for cycle_view here.
	 */
